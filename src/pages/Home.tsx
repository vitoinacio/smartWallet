...
const CardItems = [
  ...
  },
  {
    ...
    icon: <HandCoins />,
    description:
      ' Mantenha suas finanças organizadas com facilidade. Nossa ferramenta permite acompanhar seus gastos, ajustar seu orçamento e alcançar suas metas financeiras. Simplifique a gestão do seu dinheiro e fique no controle.',
  },
  {
  ...
  return (
    <div className="flex flex-col">
      ...
      <main className="mt-20 pl-24 pr-24 max-md:pl-10 max-md:pr-10  bg-gray-50 dark:bg-neutral-900">
        <section className="flex w-full pt-10 max-md:gap-4 justify-between items-center max-md:flex-col-reverse">
          <div className="flex flex-col gap-9">
            <div className="max-md:text-center">
              <h1 className="text-4xl font-bold text-blue-800 max-md:text-xl max-md:text-center">
            ...
            <div className="max-md:items-center max-md:text-center">
              <Form {...form}>
                <form
                  ...
                  className="w-2/3 space-y-6 max-md:w-full"
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <div className="flex items-center max-md:items-start">
                          ...
                          <Button type='submit' className="bg-blue-800 dark:text-slate-200 dark:hover:bg-blue-950">
                            Começar
                          </Button>
                        </div>
                        <FormDescription>Inscreva-se agora !</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
        ...
        <section
          id="oqueOferecemos"
          className="flex flex-col w-full pt-10 pb-10 items-center justify-around gap-11 scroll-mt-8"
        >
          <div className="flex flex-col text-center relative gap-5">
            <h2 className="text-4xl font-bold max-md:text-xl  text-blue-800">
          ...
          <div className="flex gap-4 max-md:flex-col">
            {CardItems.map(({ title, icon, description }, Index) => (
              <Card
                key={Index}
                className="flex flex-col items-center hover:scale-105 duration-100"
              >
                <CardHeader>
                  <CardTitle className="text-blue-950 dark:text-blue-800">
                    {title}
                  </CardTitle>
        ...
        <section
          id="QuemSomos"
          className="flex flex-col w-full pt-10 items-center gap-11 scroll-mt-8"
        >
          <h2 className="text-4xl font-bold text-blue-800 max-md:text-xl">
            Quem Somos ?
          </h2>
        ...
        <section
          id="ConhecaNossoProduto"
          className="flex flex-col w-full pt-10 pb-20 items-center gap-11 scroll-mt-8"
        >
          <div className="flex flex-col text-center gap-7">
            <h2 className="text-4xl font-bold text-blue-800 max-md:text-xl pt-10 pb-10">
              Gestão de Gastos
            </h2>
            <p className="pb-10">
            ...
            <div className="grid grid-cols-2 justify-between max-md:grid-cols-1 max-md:flex max-md:flex-col-reverse">
              <img
                src="src/img/telaPlanejamento.png"
                alt="imagem da dasboard"
              />
              <p>
